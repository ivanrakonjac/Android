    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new DatePickerDialog(requireActivity(),
                (view, year, month, dayOfMonth) -> {
                    ...
                    result.putSerializable(SET_DATE_KEY, DateTimeUtil.getDate(year, month, dayOfMonth));
                    getParentFragmentManager().setFragmentResult(WorkoutCreateFragment.REQUEST_KEY, result);
                },
