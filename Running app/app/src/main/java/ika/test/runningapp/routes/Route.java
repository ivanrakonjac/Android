...
public class Route {
    ...
    public Route(String label, String location, Drawable image,String name, double length, String difficulty, String description) {
        this.label = label;
    ...
    public static Route createFromResources(Resources resources, int index){
        ...
        String[] name = resources.getStringArray(R.array.route_names);
